...
from src.self_learning.application_scope import current_application_scope
from src.self_learning.event_schema import safe_run_id
...
def _current_run_id() -> str:
    from src.runtime.trace import MissingRunContextError, require_root_run_id
