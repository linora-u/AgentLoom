...
def _has_transient_provider_error(error: BaseException) -> bool:
    ...
    from src.adapters.smolagents.models.litellm_retry import (
        ProviderCallBudgetExceeded,
    )
    from src.adapters.smolagents.models.tool_call_parser import ToolCallParseError
...
def run(
    ...
    with output_context as active_event_stream:
        ...
        try:
            if machine_output:
                from src.application.runner import execute_app
            ...
            from src.application.run import ApplicationRunInterrupted
            ...
            from src.application.run import ApplicationRunBudgetLimited
...
def _configured_runtime_home():
    from src.configuration import C
    from src.runtime import resolve_runtime_home
...
def list_tasks(detail: bool):
    ...
    from src.runtime.checkpoint.checkpoint_manager import list_all_tasks
...
def clean_runtime_command() -> None:
    ...
    from src.configuration import C
    from src.runtime.retention import clean_runtime
...
def migrate_runtime_command(dry_run: bool) -> None:
    ...
    from src.configuration import C
    from src.runtime.migration import migrate_runtime
    from src.runtime.workspace_migration import (
...
def sessions_index(path: str):
    ...
    from src.self_learning.persistence.event_importer import (
...
def sessions_search(query: str, limit: int, agent: str | None, app: str | None, since: str | None, scope: str):
    ...
    from src.self_learning.persistence.ledger import SelfLearningLedger
...
def _review_cli_service():
    ...
    from src.self_learning.review_artifacts import ReviewCLIService
...
def skill_proposals_list():
    ...
    from src.self_learning.proposal_writer import ProposalWriter
