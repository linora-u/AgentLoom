...
provided by :mod:`agentloom.app.studio.builder`.
"""
...
def _system_prompt(profile: ChatModelProfile) -> str:
    return (
        ...
        "An Agent YAML must include non-empty name, description, and task. "
        "Use task for a user request or an ordered list of user requests. "
        "Use optional system_prompt for long-lived instructions, either inline or as {path: ...}. "
        "Do not create Markdown Agent definitions or use workflow, tasks, or runtime task overrides.\n"
