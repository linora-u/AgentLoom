...
Usage (Python API)::
    ...
    from src.application.runner import run_app
...
from src.application.run import (
...
from src.runtime.checkpoint import CheckpointManager
from src.runtime.checkpoint.file_history import FileHistoryManager
from src.configuration import C, build_effective_agent_config, get_config
from src.configuration.config import bind_config, fresh_invocation_config
from src.runtime.goal import GoalBudgetLimitedError, normalize_goal_config
from src.runtime.heartbeat import SupervisorHeartbeat
        ...
        with bind_run_context(runtime_context):
            ...
            with bind_logger_backend(logger_backend, context=runtime_context):
                ...
                try:
                    ...
                    try:
                        from src.runtime.retention import prune_runtime_if_due
                    ...
                    if is_resume and checkpoint_mgr is not None:
                        ...
                        if tree_status == "running":
                            from src.runtime.heartbeat.status import detect_crashed_status
                    ...
                    if checkpoint_mgr is not None:
                        ...
                        from src.runtime.checkpoint.coordinator import (
                    ...
                    try:
                        ...
                        from src.adapters.lsp.config import LSPConfig
