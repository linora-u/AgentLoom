...
class RuntimeMigration:
    ...
    def migrate(
        ...
        *,
        ...
        from src.runtime.checkpoint.checkpoint_manager import CheckpointTaskLease
    ...
    def _workflow_identity(self, yaml_path: str) -> _WorkflowIdentity | str:
        ...
        from src.runtime.factory import YamlAgentFactory
        from src.application.runner import validate_required_yaml_fields
...
def validate_migrated_checkpoint(candidate: MigrationCandidate, destination: Path) -> None:
    ...
    if context_store_dir.is_dir():
        from src.runtime.context_engine.store import ContextStore
