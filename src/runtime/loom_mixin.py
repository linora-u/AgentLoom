...
from src.runtime.hooks import wrap_in_system_reminder
from src.runtime.memory.context_compression import ConversationHistoryManager
from src.adapters.smolagents.tool_protocol import action_step_to_protocol_messages
...
def append_current_todo_state(messages: list, *, todo_mode: str) -> list:
    ...
    if todo_mode == "off":
        return messages
    from src.runtime.todo import get_current_todo_provider
...
class LoomAgentMixin:
    ...
    def _consolidate_error_messages(self, messages: list) -> list:
        ...
        try:
            ...
            from src.runtime.error_recovery import (
