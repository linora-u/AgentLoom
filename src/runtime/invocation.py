...
from src.runtime.hooks import HookEvent, HookRun
...
class AgentInvocation:
    ...
    def _execute_bound(
        ...
        *,
        ...
        from src.runtime.goal import bind_goal_state_provider
        from src.runtime.todo import ensure_todo_state_provider
        ...
        try:
            ...
            from src.runtime.goal import GoalBudgetLimitedError
        ...
        *,
        ...
        while True:
            ...
            try:
                ...
                from src.runtime.goal import GoalBudgetLimitedError, GoalCompleteError
    ...
    def _review_finished_run(self) -> None:
        owner = self.owner
        try:
            from src.self_learning.paths import review_config, self_learning_enabled
            ...
            if self_learning_enabled(effective_config) and any(
                ...
                from src.self_learning.reviewer import review_finished_run
