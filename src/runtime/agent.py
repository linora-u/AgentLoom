...
if TYPE_CHECKING:
    from src.application.lifecycle import ApplicationRunLifecycle
...
from src.adapters.smolagents.agents import CodeAgentV2, ToolCallingAgentV2
from src.adapters.smolagents.models.model_manager import (
    ModelConfigBuilder,
    get_model,
)
from src.adapters.smolagents.tool_shim import clone_tool_for_runtime, inject_hooks
from src.adapters.smolagents.tools.tools import ensure_tool_wrapped
...
from src.configuration.defaults import DEFAULT_MAX_TOKENS
...
from src.runtime.invocation import current_worker_memory, require_successful_runtime_result
from src.runtime.loom_mixin import LoomAgentMixin  # noqa: F401 - historical base_agent export
from src.runtime.logging import (
    get_global_logger,
    get_logger,
)
from src.runtime.prompts.prompt_builder import build_prompt_templates
...
from src.runtime.workspace import ensure_workspace_mounted_once
...
class BaseAgent(ABC):
    ...
    def _inject_memory_snapshot(self, tasks: list[str]) -> list[str]:
        ...
        try:
            ...
            from src.self_learning.persistence.memory_store import MemoryStore
...
class RoleDrivenAgent(BaseAgent):
    ...
    def _build_runtime_tools(self, profile: AgentRoleProfile) -> list:
        ...
        if profile.agent_type is AgentType.SUPERVISOR:
            from src.runtime.goal import normalize_goal_config
    ...
    def run(
        ...
        def _run_once() -> str:
            from src.runtime.invocation import AgentInvocation
