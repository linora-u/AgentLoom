...
from src.runtime.heartbeat.status import (
...
from src.runtime import SecureDirectory, portable_runtime_component
from src.runtime.todo.model import (
    TODO_SCHEMA_VERSION,
    empty_todo_snapshot,
...
class CheckpointManager:
    ...
    :class:`src.runtime.RuntimeContext`.  Management and tests may pass an
    ...
    def load_todos(self, task_id: str, agent_path: str) -> dict[str, Any]:
        ...
        from src.runtime import safe_agent_path
    ...
    def load_goal(self, task_id: str) -> dict[str, Any] | None:
        ...
        from src.runtime.goal import validate_goal_state
