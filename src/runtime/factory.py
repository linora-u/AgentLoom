...
from src.configuration import C, get_code_agent_config, get_default_toolsets
...
from src.runtime.goal import normalize_goal_config, normalize_workflow_for_goal
from src.adapters.smolagents import AgentLogger
from src.application.validation import AgentConfigNormalizer, NormalizedAgentConfig
from src.runtime.agent import AgentRoleProfile, AgentType, RoleDrivenAgent
from src.utils.dynamic_import import load_function
from src.tools.catalog import resolve_toolsets
from src.tools.loader import resolve_tool_function
from src.application.workflows import get_worker_agent_yaml_path, infer_category_from_yaml_path
    ...
    def agent_as_tool(self):
        ...
        **Factory mode (thread-safe)**: Each call to the returned tool function
        ...
        def dynamic_agent_tool(*args, **kwargs) -> str:
            ...
            from src.runtime.context_engine.runtime import get_active_context_engine
        ...
        def batch(tasks, concurrency=None, on_progress=None):
            ...
            """
            from src.runtime.concurrency import ParallelAgentExecutor
...
def _load_mcp_tools(
    *,
    ...
    try:
        from src.adapters.mcp.config import merge_mcp_configs, parse_mcp_yaml_value
...
class YamlAgentFactory:
    ...
    def get_tools_from_config(config: dict, logger: Optional[AgentLogger] = None, effective_agent_config: Optional[dict] = None) -> tuple:
        ...
        if 'tools' not in config:
            ...
            from src.runtime.permissions.policy_summary import patch_shell_tool_security
