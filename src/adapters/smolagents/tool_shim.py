...
from src.runtime.checkpoint.file_history_hook import record_active_file_history
from src.runtime.logging import get_logger
from src.runtime.tool_protocol import TOOL_SETTLER_ATTR, ToolCallRecord
from src.runtime.trusted_memory_evidence import (
    TRUSTED_MEMORY_EVIDENCE_RESPONSE_KEY,
    TrustedMemoryEvidenceEnvelope,
    extract_trusted_memory_evidence,
)
from src.runtime.trace import get_current_hook_run

from src.runtime.hooks.path_validators import enforce_core_tool_guard
from src.runtime.hooks.type_coercion import coerce_tool_parameters
from src.runtime.hooks.types import (
    HookContext,
    HookEvent,
    HookResult,
...
def _build_runtime_context(
    ...
    *,
    ...
    from src.runtime.hooks.runtime import _runtime_workspace_fields
...
def _observe_final_tool_input(context: HookContext) -> None:
    ...
    from src.self_learning.session_recorder import session_recorder_hook
