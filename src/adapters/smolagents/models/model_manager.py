...
from src.adapters.smolagents.models.litellm_model import LiteLLMModelV2
from src.adapters.smolagents.models.litellm_retry import patch_litellm_completion
from src.adapters.smolagents.models.request_headers import (
    build_model_request_headers,
    get_system_model_request_headers,
)
from src.adapters.smolagents.tool_protocol import patch_litellm_tool_error_projection
...
class ModelManager:
    ...
    def get_smolagents_model(
        ...
        try:
            from src.runtime.concurrency.rate_limiter import GlobalRateLimiterRegistry
