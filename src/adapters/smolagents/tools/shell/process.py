...
from agentloom.adapters.smolagents.tools.shell.ansi_stripper import strip_ansi
from agentloom.adapters.smolagents.tools.shell.pipe_redirect import rearrange_pipe_command
from agentloom.adapters.smolagents.tools.shell.shell_session import ShellSession
from agentloom.adapters.smolagents.tools.shell.shell_snapshot import create_snapshot, remove_snapshot
from agentloom.adapters.smolagents.tools.shell.stall_watchdog import detect_stall_prompt
from agentloom.runtime.subprocess_env import build_subprocess_env as _build_subprocess_env
from agentloom.adapters.smolagents.tools.shell.tree_kill import SizeWatchdog, graceful_kill
    ...
    **Standalone** (session_scoped=False):
    ...
    def _exec_subprocess(
        ...
        try:
            ...
            from agentloom.adapters.smolagents.tools.shell.stall_watchdog import StallWatchdog
            ...
            while elapsed < timeout:
                try:
                    ...
                    if fg_stall and fg_stall.stall_message and proc.poll() is None:
                        ...
                        try:
                            from agentloom.adapters.smolagents.tools.shell.shell_audit_log import (
    ...
    def _promote_to_background(
        ...
        """
        from agentloom.adapters.smolagents.tools.shell.background_task import BackgroundTaskRegistry
