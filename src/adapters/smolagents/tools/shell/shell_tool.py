...
from agentloom.adapters.smolagents.tools.shell.command_semantics import interpret_exit_code
...
def _run_in_background(
    ...
    from agentloom.adapters.smolagents.tools.shell.process import _MAX_OUTPUT_BYTES, find_suitable_shell
