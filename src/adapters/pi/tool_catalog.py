...
def tool_specs() -> tuple[ToolSpec, ...]:
    return (_spec(
        ...
        "write", "agentloom.adapters.pi.native_tools", "pi_write", "Write a file with the official Pi SDK.",
        ...
        "edit", "agentloom.adapters.pi.native_tools", "pi_edit", "Edit a file with the official Pi SDK.",
        "file_ops", fixed_arg_names=(), is_read_only=False, is_destructive=True, is_concurrency_safe=False,
        path_params=("path",), owner="runtime", provider="pi", logical_name="edit_file", capability="file.edit", operation="write",
    ), _spec(
        "bash", "agentloom.adapters.pi.native_tools", "pi_bash", "Run a command with the official Pi SDK.",
