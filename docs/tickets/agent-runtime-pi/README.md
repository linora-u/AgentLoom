...
**先看当前进度，再看依赖图。** 01–09 已有本票完成记录，10–14 按前置继续推进。04、05、06、07、08 已正式合入 main；09 已与该 main 集成并完成验收，按同一交付流程保留原分阶段提交。06、09 均不重开，10、11、13 的前置已满足。14 项都是完整交付的必做项，“可并行”不表示可省略。
