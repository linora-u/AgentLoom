...
**先看当前进度，再看依赖图。** 01–09、11 已有本票完成记录，10、12、13、14 按前置继续推进。04、05、06、07、08、09、11 已正式合入 main，保留原分阶段提交；09 的交付提交为 `cc0edeb1`，11 为 `96db1542`，两票 worktree 均已清理。06、09、11 均不重开；10、13 已有独立工作区，12 等 10，14 等 12+13。14 项都是完整交付的必做项，“可并行”不表示可省略。
...
| 10 / 13 | 继续各自已有 session/worktree 并行 | 领取前核对工作区；从包含已验收依赖的最新 main 开始，不复制另一分支未提交内容 |
| 12 | 等 10 完成后启动 | Pi adapter 链按 10→12 串行，可与仍在进行的 13 并行 |
| 14 | 最后串行收口 | 11 已完成；等 12+13 全部集成，不提前开旧基线工作区 |
...
上表解释职责链，不要求重开已完成的 04/05/07/08。现在 06、09、11 均已完成；10、13 已有独立工作区，继续前核对所属 session。12 等 10，14 等 12+13；新工作区使用包含已验收依赖的最新 main。人员安排不增加技术依赖。
