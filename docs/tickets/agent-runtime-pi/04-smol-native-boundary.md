...
**Status:** in-progress — 独立 worktree `t04` / 分支 `codex/pi-t04-smol`，起点 `9d5a88915efbd402d0f2697318125933fc1500e0`（已包含 03 冻结结果及待合入研究文档）。阶段提交和验收见 [实施记录](04-implementation.md)。
