...
export const uvPythonBridgeCommand = ["uv", "run", "python", "-I", "-u", "-m", "agentloom_tui_bridge"] as const
...
export function resolvePythonBridgeCommand(
  ...
  if (installedPython) return [installedPython, "-I", "-u", "-m", "agentloom_tui_bridge"] as const
  ...
  if (projectPython) return [projectPython, "-I", "-u", "-m", "agentloom_tui_bridge"] as const
