...
import { AgentLoomSession, type StudioClient, type StudioBackend } from "./session"
import { AgentLoomApp } from "./view"
import { createSourceUpdateClient, type UpdateClient } from "../update/source-updater"

export type RunStudioInput = {
  client: StudioBackend
  studio: StudioClient
...
export type StudioExitReason = "exit" | "restart"

export async function runStudio(input: RunStudioInput): Promise<StudioExitReason> {
  ...
  let exitReason: StudioExitReason = "exit"
