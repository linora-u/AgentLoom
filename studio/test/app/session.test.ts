...
import { AgentLoomSession, type StudioClient, type StudioBackend } from "../../src/app/session"
...
class FakeClient implements StudioBackend {
...
function deferredSystemDetailClient(requests: Deferred<SystemDetailResultDto>[]): StudioBackend {
  return {
...
describe("AgentLoom Studio session", () => {
