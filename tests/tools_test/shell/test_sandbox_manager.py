...
from agentloom.runtimes.smolagents.tools.shell.should_use_sandbox import should_use_sandbox
...
class TestShouldUseSandboxWrapper:
    ...
    @patch("agentloom.runtimes.smolagents.tools.shell.should_use_sandbox.SandboxManager")
