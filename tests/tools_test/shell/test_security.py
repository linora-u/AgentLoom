...
class TestSafeCommands:
    ...
    @patch("agentloom.runtime.tool_governance.shell.security.C.get_nested", side_effect=_mock_config_all_enabled)
...
class TestBoundaryConditions:
    ...
    @patch("agentloom.runtime.tool_governance.shell.security.C.get_nested", side_effect=_mock_config_all_disabled)
    ...
    @patch("agentloom.runtime.tool_governance.shell.security.C.get_nested")
