...
def test_builtin_loader_selects_smol_owned_implementation(name):
    ...
    assert spec.implementation.module.startswith("agentloom.runtimes.smolagents.tools.")
    assert resolve_tool_function(name).__module__.startswith("agentloom.runtimes.smolagents.tools.")
