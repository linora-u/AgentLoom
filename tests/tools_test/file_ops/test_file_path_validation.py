...
def _mock_agent_context():
    ...
    return patch(
        "agentloom.execution.trace.task_context.get_current_agent_config",
...
def _mock_workspace(ws_path, include_paths=None, exclude_paths=None):
    ...
    """
    from agentloom.execution.permissions.path_validation import PathValidationResult
    ...
    return patch("agentloom.execution.permissions.validate_path", side_effect=_validate)
