...
def test_legacy_todo_runtime_and_prompt_contracts_are_absent() -> None:
    runtime_files = [
        PROJECT_ROOT / "agentloom/runtime/loom_mixin.py",
        PROJECT_ROOT / "agentloom/runtime/agent.py",
        PROJECT_ROOT / "agentloom/tools/todo/todo_write.py",
    ]
    prompt_files = list((PROJECT_ROOT / "agentloom/runtime/prompts").glob("**/*.example.yaml"))
