...
def test_prompt_templates_document_system_reminders() -> None:
    ...
    prompt_files = [
        root / "src/runtimes/smolagents/prompts/toolcalling_agent.example.yaml",
        root / "src/runtimes/smolagents/prompts/anthropic/toolcalling_agent.example.yaml",
        root / "src/runtimes/smolagents/prompts/openai/toolcalling_agent.example.yaml",
        root / "src/runtimes/smolagents/prompts/gemini/toolcalling_agent.example.yaml",
    ]
