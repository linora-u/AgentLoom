...
```bash
AGENTLOOM_RUNTIME_ROOT=/tmp/agentloom-context-engine-text \
  .venv/bin/loom run applications/context_engine_text_retrieve_validation/workflows/context_engine_text_retrieve_validation_agent.yaml
```
...
AGENTLOOM_RUNTIME_ROOT=/tmp/agentloom-context-engine-apps \
  .venv/bin/python tests/agent_test/context_engine/real_context_engine_application_validation.py --case text
```
